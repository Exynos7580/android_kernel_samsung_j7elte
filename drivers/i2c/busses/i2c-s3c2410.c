...
static int s3c24xx_i2c_init(struct s3c24xx_i2c *i2c)
{
	...
	if(i2c->need_bus_clear) {
		iicstat = 0x00;
		iicstat |= S3C2410_IICSTAT_MASTER_TX | S3C2410_IICSTAT_TXRXEN;
		writel(iicstat, i2c->regs + S3C2410_IICSTAT);

		writel(0xff, i2c->regs + S3C2410_IICDS);

		iicstat |= S3C2410_IICSTAT_MASTER_TX | S3C2410_IICSTAT_START
...
s3c24xx_i2c_parse_dt(struct device_node *np, struct s3c24xx_i2c *i2c)
{
	...
	if (of_find_property(np, "supports-bus-clear", NULL))
		i2c->need_bus_clear = 1;
}
#else
static void
s3c24xx_i2c_parse_dt(struct device_node *np, struct s3c24xx_i2c *i2c)
