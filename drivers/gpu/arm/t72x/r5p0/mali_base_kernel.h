...
/* IN */
	...
	BASE_MEM_SECURE = (1U << 5),
	BASE_MEM_CRC_PARTIAL_UPDATE  = (1U << 6),      /**< CRC Buffer is allocated by gralloc */
	 ...
	 */
	BASE_MEM_HINT_CPU_RD = (1U << 0),      /**< Heavily read CPU side
						    - OBSOLETE */
	BASE_MEM_HINT_CPU_WR = (1U << 1),      /**< Heavily written CPU side
						    - OBSOLETE */
	BASE_MEM_HINT_GPU_RD = (1U << 2),      /**< Heavily read GPU side
						    - OBSOLETE */
	BASE_MEM_HINT_GPU_WR = (1U << 3),      /**< Heavily written GPU side
						    - OBSOLETE */
