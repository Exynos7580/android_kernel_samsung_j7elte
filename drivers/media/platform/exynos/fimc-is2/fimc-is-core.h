 ...
 */
#define SIZE_FD_SHOT_BUF		SZ_32K

#define NUM_FD_INTERNAL_BUF		(3)
#define MAX_FD_SHOT_BUF		(10)
...
#elif defined(CONFIG_SOC_EXYNOS5430) || defined(CONFIG_SOC_EXYNOS5433)  || defined(CONFIG_SOC_EXYNOS7420) || defined(CONFIG_SOC_EXYNOS7580)
#define DVFS_L0				(600000)
#define DVFS_L1				(500000)
#define DVFS_L1_1			(480000)
#define DVFS_L1_2			(460000)
