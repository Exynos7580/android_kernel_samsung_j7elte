 ...
 * 2015.10.19 : Release Version 2.1.5
 *    - Change from memcpy to strncpy in sdcardfs_read_super
 *          because dev_name can be smaller than PATH_MAX
 */

#define SDCARDFS_VERSION "2.1.5"
